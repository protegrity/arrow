...
TEST(ExternalDbpaConcurrencyTest, FailsWhenUseThreadsTrue) {
  ...
  col_builder.key("key1234567890123");
  enc_cols["f0"] = col_builder.build();

  const std::string lib_path =
      parquet::encryption::external::test::TestUtils::GetTestLibraryPath();

  parquet::ExternalFileEncryptionProperties::Builder fep_builder("footer_key123456");
  ...
  kr->PutKey("kf", "footer_key123456");
  kr->PutKey("key1234567890123", "key1234567890123");
