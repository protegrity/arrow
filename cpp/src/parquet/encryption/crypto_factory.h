...
struct PARQUET_EXPORT EncryptionConfiguration {
  ...
  /// Returns true if any of the external KMS fields are configured
  bool IsExternal() const {
    return !host.empty() ||
           !certificate_authority_location.empty() ||
           !client_certificate_location.empty() ||
           !client_key_location.empty() ||
