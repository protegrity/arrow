...
ExternalFileDecryptionProperties::Builder::build_external() {
  return std::shared_ptr<ExternalFileDecryptionProperties>(
      new ExternalFileDecryptionProperties(
          ...
          app_context_, configuration_properties_, parquet_crypto_provider_));
}
...
std::shared_ptr<ColumnEncryptionProperties> ColumnEncryptionProperties::Unencrypted() {
  return std::shared_ptr<ColumnEncryptionProperties>(
      new ColumnEncryptionProperties(/*encrypted=*/false, "", {}, {}, std::nullopt));
}

std::shared_ptr<ColumnEncryptionProperties> ColumnEncryptionProperties::WithFooterKey() {
  return std::shared_ptr<ColumnEncryptionProperties>(
      new ColumnEncryptionProperties(/*encrypted=*/true, "", {}, {}, std::nullopt));
}
...
std::shared_ptr<ColumnEncryptionProperties> ColumnEncryptionProperties::WithColumnKey(
  ...
  return std::shared_ptr<ColumnEncryptionProperties>(new ColumnEncryptionProperties(
      /*encrypted=*/true, "", std::move(key), std::move(key_metadata), std::nullopt));
}
...
ExternalFileEncryptionProperties::Builder::build_external() {
  return std::shared_ptr<ExternalFileEncryptionProperties>(
      new ExternalFileEncryptionProperties(
          ...
          configuration_properties_, parquet_crypto_provider_));
}
