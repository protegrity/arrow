...
class ExternalV1 {
 public:
  ...
  ExternalV1(const ExternalV1&) noexcept;
  ExternalV1& operator=(const ExternalV1&) noexcept;
  ExternalV1() noexcept;

  virtual ~ExternalV1() noexcept;

  bool operator == (const ExternalV1 & /* rhs */) const;
  bool operator != (const ExternalV1 &rhs) const {
    return !(*this == rhs);
  }

  bool operator < (const ExternalV1 & ) const;
...
typedef struct _EncryptionAlgorithm__isset {
  _EncryptionAlgorithm__isset() : AES_GCM_V1(false), AES_GCM_CTR_V1(false), EXTERNAL_V1(false) {}
  bool AES_GCM_V1 :1;
...
class EncryptionAlgorithm {
 public:
  ...
  void __set_EXTERNAL_V1(const ExternalV1& val);
