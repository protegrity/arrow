...
ExternalV1::~ExternalV1() noexcept {
}

ExternalV1::ExternalV1() noexcept {
}
std::ostream& operator<<(std::ostream& out, const ExternalV1& obj)
{
  obj.printTo(out);
  return out;
}
...
void swap(ExternalV1 &a, ExternalV1 &b) {
  using ::std::swap;
  (void) a;
  (void) b;
}

bool ExternalV1::operator==(const ExternalV1 & /* rhs */) const
{
  return true;
}

ExternalV1::ExternalV1(const ExternalV1& other234) noexcept {
  (void) other234;
}
ExternalV1& ExternalV1::operator=(const ExternalV1& other235) noexcept {
  (void) other235;
  return *this;
}
void ExternalV1::printTo(std::ostream& out) const {
  using ::apache::thrift::to_string;
  out << "ExternalV1(";
  out << ")";
}
...
void EncryptionAlgorithm::__set_EXTERNAL_V1(const ExternalV1& val) {
  this->EXTERNAL_V1 = val;
__isset.EXTERNAL_V1 = true;
}
...
void swap(EncryptionAlgorithm &a, EncryptionAlgorithm &b) {
  ...
  swap(a.EXTERNAL_V1, b.EXTERNAL_V1);
  swap(a.__isset, b.__isset);
}
...
bool EncryptionAlgorithm::operator==(const EncryptionAlgorithm & rhs) const
{
  ...
  if (__isset.AES_GCM_CTR_V1 != rhs.__isset.AES_GCM_CTR_V1)
    ...
    return false;
  if (__isset.EXTERNAL_V1 != rhs.__isset.EXTERNAL_V1)
    return false;
  else if (__isset.EXTERNAL_V1 && !(EXTERNAL_V1 == rhs.EXTERNAL_V1))
    return false;
  return true;
}
...
EncryptionAlgorithm::EncryptionAlgorithm(const EncryptionAlgorithm& other236) {
  ...
  EXTERNAL_V1 = other236.EXTERNAL_V1;
...
EncryptionAlgorithm& EncryptionAlgorithm::operator=(const EncryptionAlgorithm& other237) {
  ...
  EXTERNAL_V1 = other237.EXTERNAL_V1;
...
void EncryptionAlgorithm::printTo(std::ostream& out) const {
  ...
  out << ", " << "EXTERNAL_V1="; (__isset.EXTERNAL_V1 ? (out << to_string(EXTERNAL_V1)) : (out << "<null>"));
  out << ")";
}
