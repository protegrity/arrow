...
template <class Protocol_>
uint32_t ExternalV1::read(Protocol_* iprot) {
...
template <class Protocol_>
uint32_t ExternalV1::write(Protocol_* oprot) const {
  uint32_t xfer = 0;
  ::apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("ExternalV1");
...
uint32_t EncryptionAlgorithm::read(Protocol_* iprot) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 3:
        if (ftype == ::apache::thrift::protocol::T_STRUCT) {
          xfer += this->EXTERNAL_V1.read(iprot);
          this->__isset.EXTERNAL_V1 = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        break;
...
uint32_t EncryptionAlgorithm::write(Protocol_* oprot) const {
  ...
  if (this->__isset.EXTERNAL_V1) {
    xfer += oprot->writeFieldBegin("EXTERNAL_V1", ::apache::thrift::protocol::T_STRUCT, 3);
    xfer += this->EXTERNAL_V1.write(oprot);
    xfer += oprot->writeFieldEnd();
  }
  xfer += oprot->writeFieldStop();
  xfer += oprot->writeStructEnd();
