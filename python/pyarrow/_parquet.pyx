...
cdef shared_ptr[WriterProperties] _create_writer_properties(
    ...
    if encryption_properties is not None:
        if isinstance(encryption_properties, ServiceFileEncryptionProperties):
            props.encryption(
                static_pointer_cast[CFileEncryptionProperties, CServiceFileEncryptionProperties](
                    (<ServiceFileEncryptionProperties>encryption_properties).unwrap_external()))
        else:
            props.encryption(
